...
@section('content')
    ...
    <form action="{{route('informasi.update', $information->id)}}" method="post" enctype="multipart/form-data"> 
        @csrf
        @method('put')
        <div class="row">
            <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <img src="/image/{{ $information->gambar }}" width="300px">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="judul_informasi" value="{{$information->judul}}" class="form-control" placeholder="Judul Informasi" id="inputJudul"/>
                                </div>
                            </div>
                        </div>
